 ...
 */
package com.github.jorgecastilloprz.dagger2scopes.datasources.mock;
...
import com.github.jorgecastilloprz.dagger2scopes.datasources.mock.model.MockLucasArtGame;
 ...
 */
public class MockGameDataSource implements GameDataSource {

  private List<MockGame> games;
  private DataSourceMapper dataSourceMapper;

  @Inject MockGameDataSource(DataSourceMapper dataSourceMapper) {
    initCatalog();
  ...
  private void initCatalog() {
    ...
    MockLucasArtGame lucasArtGame = new MockLucasArtGame(
        "http://upload.wikimedia.org/wikipedia/en/5/5e/Maniac_Mansion_artwork.jpg",
        "Maniac Mansion", "1987",
    ...
    lucasArtGame = new MockLucasArtGame(
        "http://upload.wikimedia.org/wikipedia/en/1/17/Zak_McKracken_artwork.jpg", "Zak McKracken",
        "1988", "Zak McKracken and the Alien Mindbenders is a graphical "
    ...
    lucasArtGame = new MockLucasArtGame("http://www.juegomania.org/emuladores/pc/6/6210.jpg",
    ...
    lucasArtGame = new MockLucasArtGame("http://img.gamefaqs.net/screens/a/7/4/gfs_45322_2_19.jpg",
    ...
    lucasArtGame =
        new MockLucasArtGame("http://wolf.flatrock.org.nz/images/Sam_and_Max.JPG", "Sam and Max",
    ...
    lucasArtGame =
        new MockLucasArtGame("http://jogorama.com.br/arquivos/telas/3158/3158_13.jpg", "The Dig",
    ...
    lucasArtGame =
        new MockLucasArtGame("https://beforeitsoverau.files.wordpress.com/2014/08/167_4.jpg",
  ...
  @Override public List<Game> getGames() {
    ...
    return dataSourceMapper.mapFromSourceToModel(games);
  }
}
